...
export default function SwipeToComplete({ onComplete, disabled, color = 'green' }: Props) {
  ...
  return (
    <View style={styles.track}>
      <Animated.View style={[styles.fill, { width: fillWidth, backgroundColor: thumbColor }]} />
      <Animated.Text style={[styles.label, { opacity: trackOpacity }]}>Swipe to complete mission →</Animated.Text>
      <Animated.View
        style={[styles.thumb, { transform: [{ translateX }], backgroundColor: thumbColor, shadowColor: thumbColor }]}
