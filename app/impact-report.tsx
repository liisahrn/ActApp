		...
		<View style={S.fill}>
			...
			>
				...
				>
						...
						{todaysAction && (
							<View style={styles.actionBox}>
								<Text
									style={[
										S.body,
										{ fontSize: Fonts.sizes.md, textAlign: "center" },
									]}
								>
									{todaysAction.title}
								</Text>
						...
						<View style={styles.sectionCard}>
							...
							{countries.map((row, i) => (
								<View key={row.country} style={styles.countryRow}>
									...
									<Text
										style={[S.body, { flex: 1, fontSize: Fonts.sizes.sm }]}
										numberOfLines={1}
									>
										{row.country}
									</Text>
					...
					<Text
						style={[S.muted, { textAlign: "center", fontSize: Fonts.sizes.sm }]}
					>
