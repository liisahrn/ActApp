...
export default function FriendsScreen() {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: functions are defined in component scope and would cause infinite re-renders if added as deps; session is the correct trigger
	useEffect(() => {
	...
	const enrichWithStreaks = async (
		profiles: Omit<LeaderboardUser, "current_streak">[],
	...
	const renderUser = ({
		...
		return (
			<Card
				row
				className={`gap-3 p-[14] ${isMe ? "border-primary border-[1.5]" : ""}`}
			>
				<Text
					style={{
